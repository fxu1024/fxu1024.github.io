...
- PvC CDW virtual warehouses support Kerberos authentication from PvC 1.5.0 (Jan 2023), unfortunately there are many limitations on beeline version, impala version, python version and commandline attributes.
