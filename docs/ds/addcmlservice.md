...
```bash
# export host=ml-47e0ade8-e0a.apps.ecs-lb.sme-feng.athens.cloudera.com
...
Signature ok
subject=/CN=ml-47e0ade8-e0a.apps.ecs-lb.sme-feng.athens.cloudera.com/OU=PS/O=Cloudera, Inc./ST=CA/C=US
...
```bash
# scp ${host}.crt ${host}.key cloudera@feng-ws1.sme-feng.athens.cloudera.com:~
cloudera@feng-ws1.sme-feng.athens.cloudera.com's password:
ml-47e0ade8-e0a.apps.ecs-lb.sme-feng.athens.cloudera.com.crt                                                                                                                                            100% 1927     1.4MB/s   00:00
ml-47e0ade8-e0a.apps.ecs-lb.sme-feng.athens.cloudera.com.key                                                                                                                                            100% 2484     1.1MB/s   00:00

# scp /opt/cloudera/security/pki/chain.pem cloudera@feng-ws1.sme-feng.athens.cloudera.com:~
cloudera@feng-ws1.sme-feng.athens.cloudera.com's password:
